...
var circleDonutChart = function(chartElementID){
	...
	this.draw = function(options){
		...
		if (!oTester.size){
			svg.setAttribute('width', 106*options.scaling);
			svg.setAttribute('height', 106*options.scaling);
			options.size = 106*options.scaling;
		}
		...
		innerCircleDOM.setAttribute('r', 86*options.scaling);
		innerCircleDOM.setAttribute('stroke', 'none');
		innerCircleDOM.setAttribute('stroke-width', '1');
		innerCircleDOM.setAttribute('fill', '#101a63' );

		outerCircleDOM.setAttribute('fill', '#ED1111');
		outerCircleDOM.setAttribute('stroke', 'none');
		outerCircleDOM.setAttribute('stroke-width', '8');
